...
--
-- Table structure for table `auditoria_seccion_guias_aprendizaje`
--

DROP TABLE IF EXISTS `auditoria_seccion_guias_aprendizaje`;
...
--
-- Dumping data for table `auditoria_seccion_guias_aprendizaje`
--

LOCK TABLES `auditoria_seccion_guias_aprendizaje` WRITE;
/*!40000 ALTER TABLE `auditoria_seccion_guias_aprendizaje` DISABLE KEYS */;
/*!40000 ALTER TABLE `auditoria_seccion_guias_aprendizaje` ENABLE KEYS */;
UNLOCK TABLES;
