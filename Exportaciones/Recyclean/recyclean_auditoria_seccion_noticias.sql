...
--
-- Table structure for table `auditoria_seccion_noticias`
--

DROP TABLE IF EXISTS `auditoria_seccion_noticias`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `auditoria_seccion_noticias` (
  `id_audi` int NOT NULL AUTO_INCREMENT,
  `Audi_SNFechaAnterior` date DEFAULT NULL,
  `Audi_SNFechaNuevo` date DEFAULT NULL,
...
--
-- Dumping data for table `auditoria_seccion_noticias`
--

LOCK TABLES `auditoria_seccion_noticias` WRITE;
/*!40000 ALTER TABLE `auditoria_seccion_noticias` DISABLE KEYS */;
/*!40000 ALTER TABLE `auditoria_seccion_noticias` ENABLE KEYS */;
UNLOCK TABLES;
