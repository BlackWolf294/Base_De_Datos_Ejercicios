...
CREATE TABLE `auditoria_registro` (
  ...
  `Audi_RegFechaAnterior` date DEFAULT NULL,
  `Audi_RegFechaNuevo` date DEFAULT NULL,
...
--
-- Dumping data for table `auditoria_registro`
--

LOCK TABLES `auditoria_registro` WRITE;
/*!40000 ALTER TABLE `auditoria_registro` DISABLE KEYS */;
/*!40000 ALTER TABLE `auditoria_registro` ENABLE KEYS */;
UNLOCK TABLES;
