...
--
-- Table structure for table `auditoria_ranking`
--

DROP TABLE IF EXISTS `auditoria_ranking`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `auditoria_ranking` (
  `id_audi` int NOT NULL AUTO_INCREMENT,
  `Audi_RanPuntajeAnterior` int DEFAULT NULL,
  `Audi_RanPosicionAnterior` bigint DEFAULT NULL,
  `Audi_RanPuntajeNuevo` int DEFAULT NULL,
  `Audi_RanPosicionNUevo` bigint DEFAULT NULL,
...
--
-- Dumping data for table `auditoria_ranking`
--

LOCK TABLES `auditoria_ranking` WRITE;
/*!40000 ALTER TABLE `auditoria_ranking` DISABLE KEYS */;
/*!40000 ALTER TABLE `auditoria_ranking` ENABLE KEYS */;
UNLOCK TABLES;
